xdescribe('leetcode 417: description', () => {
    ...
    function canReach(heights: number[][], r: number, c: number, currentPath: number[][], oceanSet: Set<string>, visited: Set<string>): boolean {
        ...
        const result = canReachAtlantic(heights, r + 1, c, currentPath, oceanSet, visited) || canReachAtlantic(heights, r - 1, c, currentPath, oceanSet, visited) || canReachAtlantic(heights, r, c + 1, currentPath, oceanSet, visited) || canReachAtlantic(heights, r, c - 1, currentPath, oceanSet, visited);
