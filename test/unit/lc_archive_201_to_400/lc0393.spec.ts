xdescribe('leetcode 393: utf 8 validation', () => {
    ...
    function isTwoByte(num1: number, num2: number): boolean {
        return (0b10000000 & num1) > 0 && (0b01000000 & num1) > 0 && (0b00100000 & num1) === 0 && isMultiByeHelper(num2);
    }

    function isThreeByte(num1: number, num2: number, num3: number): boolean {
        return (0b10000000 & num1) > 0 && (0b01000000 & num1) > 0 && (0b00100000 & num1) > 0 && (0b00010000 & num1) === 0 && isMultiByeHelper(num2) && isMultiByeHelper(num3);
    }

    function isFourByte(num1: number, num2: number, num3: number, num4: number): boolean {
        return (0b10000000 & num1) > 0 && (0b01000000 & num1) > 0 && (0b00100000 & num1) > 0 && (0b00010000 & num1) === 0 && isMultiByeHelper(num2) && isMultiByeHelper(num3) && isMultiByeHelper(num4);
    }
