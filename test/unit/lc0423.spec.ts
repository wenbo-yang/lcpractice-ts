xdescribe('leetcode 423: description', () => {
    ...
    function originalDigits(s: string): string {
        ...
        const rankMap = new Map<number, MappingHelper[]>([
            [0, [new MappingHelper('zero', 0, 'z', 1), new MappingHelper('two', 2, 'w', 1), new MappingHelper('six', 6, 'x', 1), new MappingHelper('four', 4, 'u', 1), new MappingHelper('eight', 8, 'g', 1)]],
            [1, [new MappingHelper('five', 5, 'f', 1), new MappingHelper('one', 1, 'o', 1), new MappingHelper('seven', 7, 's', 1), new MappingHelper('three', 3, 'h', 1)]],
            [2, [new MappingHelper('nine', 9, 'i', 1)]],
        ]);
