xdescribe('leetcode 240: search in a sorted 2d matrix', () => {
    ...
    function searchForRowBoundMin(target: number, matrix: number[][]) {
        throw new Error("Function not implemented.");
    }

    function searchForRowBoundMax(target: number, matrix: number[][]) {
        throw new Error("Function not implemented.");
    }

    function searchForColumnBound(target: number, matrix: number[][]) {
        throw new Error("Function not implemented.");
    }

    function binarySearchRow(target: number, matrix: number[][], columnBound: void) {
        throw new Error("Function not implemented.");
    }
